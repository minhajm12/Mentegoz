    ...
    <div class="container-fluid">
      <div class="logo-div">
        <a class="logo" href="index.php">
          <img src="assets/img/logo-2.png" alt="" width="100%">
        </a>
      </div>
      ...
      <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
        <span class="mobile-nav-icon">
          ...
          <img id="menu____bar" src="assets/img/canvas-icon.png" width="30px">
        </span>
      </button>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav m-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle " href="services.php" id="navbarDropdown" role="button" aria-expanded="false">
              Services
            </a>
            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
              <li><a class="dropdown-item mobile-service-nav" href="web-design.php">Web Designing</a></li>
              <li><a class="dropdown-item mobile-service-nav" href="digital-marketing.php">Digital Marketing</a></li>
              <li><a class="dropdown-item mobile-service-nav" href="branding.php">Branding</a></li>
              <li><a class="dropdown-item mobile-service-nav" href="branding.php">Software Development</a></li>
              <li><a class="dropdown-item mobile-service-nav" href="branding.php">App Development</a></li>
            </ul>
          </li>
          <li class="nav-item">
      ...
      <div class="icon">
        <a class="open-canvas" onclick="opencanvas()">
          <img src="assets/img/canvas-icon.png" width="30px">
        </a>
      </div>
    </div>
...
<section class="contactcanvas" id="contactcanvas">
  ...
  <div class="contactcanvas-main">
    <div class="about">
      <h1 class="canvas-head">Mentegoz Technologies</h1>
    ...
    <div class="contact d-flex">
      <div class="details india">
        <div class="logo">
          <img src="assets/img/mentegoz-logo-blue.png" class="light-logo" alt="">
          <img src="assets/img/logo-2.png" class="dark-logo d-none" alt="">
          <img class="contry" src="assets/img/icons/country/india.png" alt="">
        </div>
      ...
      <div class="details qatar">
        <div class="logo">
          <img src="assets/img/mentegoz-logo-blue.png" class="light-logo" alt="">
          <img src="assets/img/logo-2.png" class="dark-logo d-none" alt="">
          <img class="contry" src="assets/img/icons/country/qatar.png" alt="">
        </div>
        <div class="address d-flex">
          <div class="icon">
            <i class="fa-solid fa-location-dot cnvs-icn"></i>
    ...
    <div class="close-icon">
      <a onclick="closecanvas()">
        <img src="assets/img/canvas-icon-blue.png" class="cnvs-eye-light" width="35px">
        <img src="assets/img/canvas-icon.png" class="cnvs-eye-dark d-none" width="35px">
      </a>
    </div>
    <div class="element">
