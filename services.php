...
<body>
        ...
        <div class="head__section">
          <div class="row">
            ...
            <div class="ser-ment-logo">
              <img src="assets/img/mentegoz-eye_blue.png" alt="" width="100%" class="mentservicelogo">
              <img src="assets/img/mentegoz-eye.png" alt="" width="100%" class="mentservicelogo-dark d-none">
            </div>
            <div class="element">
              <img src="assets/img/3d-element.png" class="threed_light" alt="" width="100%">
              <img src="assets/img/3d-element-dark.png" class="threed_dark d-none" alt="" width="100%">
            </div>
          </div>
        </div>
      </div>
  ...
  <script src="assets/js/service-page-scroll.js"></script>

  <!-- Service page SLide Section -->
