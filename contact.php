...
<body>
    ...
    <div class="contact-head">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <h1 class="contact-banner-head">CONTACT US</h1>
        ...
        <div class="ment-logo-contact">
            <img src="assets/img/mentegoz-eye_blue.png" alt="" class="mentservicelogo ">
            <img src="assets/img/mentegoz-eye.png" alt="" class="mentservicelogo d-none">
        </div>
        <div class="element">
            <img src="assets/img/3d-element-dark.png" alt="" width="100%">
        </div>
    </div>
            ...
            <div class="row contact-page-main">
                <div class="col-md-5 col-12 left">
                    <div class="leftsection-contact">
                        <h1>Get In Touch</h1>
                        <p>Fill up the form.<br>Our Team will get back to you within 24 hours</p>
            ...
            <div class="row">
                <div class="col-md-6 col-12 d-flex india">
                    <div class="location-box">
                        <div class="logo">
                            <img src="assets/img/mentegoz-logo-blue.png" alt="" class="dark-logo">
                            <img src="assets/img/logo-2.png" alt="" class="light-logo d-none">
                            <img src="assets/img/icons/country/india.png" alt="" class="flag">
                        </div>
                        <div class="details">
                            <div class="address">
                                <div class="icon">
                ...
                <div class="col-md-6 col-12 d-flex qatar">
                    <div class="location-box">
                        <div class="logo">
                            <img src="assets/img/mentegoz-logo-blue.png" alt="" class="dark-logo">
                            <img src="assets/img/logo-2.png" alt="" class="light-logo d-none">
                            <img src="assets/img/icons/country/qatar.png" alt="" class="flag">
                        </div>
                        <div class="details">
                            <div class="address">
                                <div class="icon">
