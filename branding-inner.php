...
<body>
    ...
    <div class="container-fluid line gy-0 gx-0">
        <div class="portfolio-banner-image">
            <div class="block block-branding">
                <img src="assets/img/portfolio/nazia/nazia.jpg" data-speed="0.75" class="img-parallax">
            </div>
        </div>
    </div>
    <!-- branding img end -->
            ...
            <div class="row">
                <div class="col-md-3 col-12">
                    <div class="branding-pg-logo">
                        <img class="img-fluid client-logo-img" src="assets/img/portfolio/nazia/nazia-logo.png" alt="">
                        <img class="img-fluid client-logo-img-dark d-none" src="assets/img/portfolio/nazia/nazia-logo-dark.png" alt="">
                    </div>
                </div>
            </div>
    ...
    <div class="branding-images">
        <div class="container gy-0 gx-0">
            <div class="branding-boxes">
                <div class="boxOne">
                    <div class="reveal">
                        <img src="assets/img/portfolio/nazia/nazia11.jpg" alt="">
                    </div>
                </div>
                <div class="boxOne">
                    <div class="reveal">
                        <img src="assets/img/portfolio/nazia/nazia12.jpg" alt="">
                    </div>
                </div>
            </div>
            <div class="branding-boxes">
                <div class="boxOne">
                    <div class="reveal">
                        <img src="assets/img/portfolio/nazia/nazia4.jpg" alt="">
                    </div>
                </div>
                <div class="boxOne">
                    <div class="reveal">
                        <img src="assets/img/portfolio/nazia/nazia5.jpg" alt="">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container line gy-0 gx-0">
        ...
        <div class="portfolio-banner-image">
            <div class="block">
                <img src="assets/img/portfolio/nazia/nazia13.jpeg" data-speed="0.75" class="img-parallax">
            </div>
        </div>
    </div>
    ...
    <div class="branding-images">
        <div class="container gy-0 gx-0">
            <div class="branding-boxes">
                <div class="boxOne">
                    <div class="reveal">
                        <img src="assets/img/portfolio/nazia/nazia7.jpg" alt="">
                    </div>
                </div>
                <div class="boxOne">
                    <div class="reveal">
                        <img src="assets/img/portfolio/nazia/nazia8.jpg" alt="">
                    </div>
                </div>
            </div>
            <div class="branding-boxes">
                <div class="boxOne">
                    <div class="reveal">
                        <img src="assets/img/portfolio/nazia/nazia14.jpg" alt="">
                    </div>
                </div>
                <div class="boxOne">
                    <div class="reveal">
                        <img src="assets/img/portfolio/nazia/nazia10.jpg" alt="">
                    </div>
                </div>
            </div>
            <div class="branding-boxes">
                <div class="boxOne">
                    <div class="reveal">
                        <img src="assets/img/portfolio/nazia/nazia15.jpeg" alt="">
                    </div>
                </div>
                <div class="boxOne">
                    <div class="reveal">
                        <img src="assets/img/portfolio/nazia/nazia16.jpeg" alt="">
                    </div>
                </div>
            </div>
            <div class="branding-boxes">
                <div class="boxOne">
                    <div class="reveal">
                        <img src="assets/img/portfolio/nazia/nazia17.jpg" alt="">
                    </div>
                </div>
                <div class="boxOne">
                    <div class="reveal">
                        <img src="assets/img/portfolio/nazia/nazia18.jpg" alt="">
                    </div>
                </div>
            </div>
        </div>
