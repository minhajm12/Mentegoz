...
function darkMode() {
  ...
  dark_mode_classes('.counter-div','text-white') 
  dark_mode_classes('.counter-label','text-white')
  ...
  dark_mode_class('.contact','contact-dark')
  ...
  dark_mode_classes('.cnvs-icn','text-white')
  ...
  dark_mode_classes('.nextservice','nextservice-dark')  // Start Your Prject Btn
  dark_mode_classes('.footer-social','footer-social-dark')  // Start Your Prject Btn
